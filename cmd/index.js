...
(0, yargs_1.default)((0, helpers_1.hideBin)(process.argv))
    ...
    const config = yield parseConfig(args);
    const domains = yield patches.readDomains(args.domains);
    yield patches.applyStripDocLinks(config, domains);
}))
    ...
    if (args.preAutomatedReplacements !== undefined) {
        ...
        yield patches.applyDocsReplacements(config, "website/**/*.markdown", args.preAutomatedReplacements, ["website/docs/index.html.markdown"]);
    }
    ...
    // Apply manual replacements - anything the automated steps can't handle
    // These are generated using the suggest command
    yield patches.applyDocsReplacements(config, "website/**/*.markdown", args.replacements, ["website/docs/index.html.markdown"]);
...
const fs_1 = __nccwpck_require__(7147);
const LinkStripConfig = zod_1.default.object({
    allowedDomains: zod_1.default.string().array().optional(),
    blockedDomains: zod_1.default.string().array().optional(),
    allowedGitHubOrgs: zod_1.default.string().array().optional(),
    blockedGitHubOrgs: zod_1.default.string().array().optional(),
});
function readDomains(path) {
    return __awaiter(this, void 0, void 0, function* () {
        if (path === "domains.json" && !(0, fs_1.existsSync)(path)) {
...
const os_1 = __nccwpck_require__(2037);
const ignore_1 = __importDefault(__nccwpck_require__(4777));
function applyDocsReplacements(ctx, pathPattern, replacementsPath, ignores) {
    return __awaiter(this, void 0, void 0, function* () {
